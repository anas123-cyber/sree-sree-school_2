...
export default function Footer() {
  return (
    <footer className="bg-primary text-white">
      ...
      <div className="w-full h-64 md:h-80 relative bg-gray-800">
        <iframe
        ...
        />
        {/* Map Overlay Card */}
        <div className="absolute bottom-4 left-4 md:bottom-8 md:left-8 bg-white text-primary p-4 rounded-xl shadow-lg max-w-xs hidden md:block">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 bg-accent rounded-full flex items-center justify-center text-white font-serif font-bold">
                SS
              </div>
              <div>
                <h3 className="font-serif font-bold text-lg">Sree Sree</h3>
